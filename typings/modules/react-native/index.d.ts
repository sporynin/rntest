...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/a783e03bb88535ac18332d27cb69c404118abbfd/react-native/index.d.ts
...
module 'react' {
    ...
    export type MeasureOnSuccessCallback = (x: number,
                                            y: number,
                                            width: number,
                                            height: number,
                                            pageX: number,
    ...
    export type MeasureInWindowOnSuccessCallback = (x: number,
                                                    y: number,
                                                    width: number,
                                                    height: number) => void

    export type MeasureLayoutOnSuccessCallback = (left: number,
                                                  top: number,
                                                  width: number,
                                                  height: number) => void
    ...
    export interface NativeMethodsMixinStatic {
         ...
         */
        measureLayout(relativeToNativeNode: number,
                      onSuccess: MeasureLayoutOnSuccessCallback,
                      onFail: () => void /* currently unused */): void;
    ...
    namespace NavigatorStatic {
        ...
        export let NavigationBar: NavigationBarStatic;
        ...
        let BreadcrumbNavigationBar: BreadcrumbNavigationBarStatic
    ...
    export namespace StyleSheet {
         ...
         */
        export let hairlineWidth: number;
         ...
         * styles.
         */
        export let absoluteFill: number;
    ...
    export interface RelayProfiler {
        attachProfileHandler(name: string,
                             handler: (name: string, state?: any) => () => void): void,

        attachAggregateHandler(name: string,
                               handler: (name: string, callback: () => void) => void): void,
    }
    ...
    export interface InteractionManagerStatic {
         ...
         * @param fn
         */
        runAfterInteractions(task: Function | SimpleTask | PromiseTask): {then: Function, done: Function, cancel: Function}
    ...
    interface ScrollResponderMixin extends SubscribableMixin {
         ...
         * @platform ios
         */
        scrollResponderZoomTo(rect: {x: number, y: number, width: number, height: number, animated?: boolean},
    ...
    export interface ToastAndroidStatic {
        ...
        showWithGravity(message: string,
                        duration: number,
                        gravity: number): void
    ...
    export interface UIManagerStatic {
         ...
         * @platform ios
         */
        takeSnapshot: (view ?: 'window' | ReactElement<any> | number,
                       options ?: {
                           width ?: number,
                           height ?: number,
                           format ?: 'png' | 'jpeg',
    ...
    export module Animated {
         ...
         * coefficient.
         */
        export function decay(value: AnimatedValue | AnimatedValueXY,
         ...
         */
        export let timing: (value: AnimatedValue | AnimatedValueXY,
         ...
         * together.
         */
        export function add(a: Animated,
                            b: Animated): AnimatedAddition;
         ...
         * together.
         */
        export function multiply(a: Animated,
                                 b: Animated): AnimatedMultiplication;
         ...
         */
        export function modulo(a: Animated,
                               modulus: number): AnimatedModulo;
        ...
        export function stagger(time: number,
                                animations: Array<CompositeAnimation>): CompositeAnimation

        /**
         * Spring animation based on Rebound and Origami.  Tracks velocity state to
         * create fluid motions as the `toValue` updates, and can be chained together.
         */
        export function spring(value: AnimatedValue | AnimatedValueXY,
         ...
         */
        export function parallel(animations: Array<CompositeAnimation>,
         ...
         *```
         */
        export function event(argMapping: Mapping[],
                              config?: EventConfig): (...args: any[]) => void;
    ...
    export interface ImageStoreStatic {
         ...
         * @platform ios
         */
        addImageFromBase64(base64ImageData: string,
    ...
    export type NavigationRenderer = (route: NavigationState,
                                      onNavigate: (action: NavigationAction) => boolean) => JSX.Element;
    ...
    export interface NavigationStateUtils {
        ...
        replaceAt(state: NavigationState,
                  key: string,
                  route: NavigationRoute): NavigationState
        replaceAtIndex(state: NavigationState,
                       index: number,
                       route: NavigationRoute): NavigationState
    ...
    export let ActivityIndicator: ActivityIndicatorStatic;
    export type ActivityIndicator = ActivityIndicatorStatic

    export let ActivityIndicatorIOS: ActivityIndicatorIOSStatic;
    export type ActivityIndicatorIOS = ActivityIndicatorIOSStatic

    export let DatePickerIOS: DatePickerIOSStatic;
    export type DatePickerIOS = DatePickerIOSStatic

    export let DrawerLayoutAndroid: DrawerLayoutAndroidStatic;
    export type DrawerLayoutAndroid = DrawerLayoutAndroidStatic

    export let Image: ImageStatic;
    export type Image = ImageStatic

    export let ImagePickerIOS: ImagePickerIOSStatic;
    export type ImagePickerIOS = ImagePickerIOSStatic

    export let LayoutAnimation: LayoutAnimationStatic;
    export type LayoutAnimation = LayoutAnimationStatic

    export let ListView: ListViewStatic;
    export type ListView = ListViewStatic

    export let MapView: MapViewStatic;
    export type MapView = MapViewStatic

    export let Modal: ModalStatic;
    export type Modal = ModalStatic

    export let Navigator: NavigatorStatic;
    export type Navigator = NavigatorStatic

    export let NavigatorIOS: NavigatorIOSStatic;
    export type NavigatorIOS = NavigatorIOSStatic

    export let Picker: PickerStatic;
    export type Picker = PickerStatic

    export let PickerIOS: PickerIOSStatic;
    export type PickerIOS = PickerIOSStatic

    export let ProgressBarAndroid: ProgressBarAndroidStatic;
    export type ProgressBarAndroid = ProgressBarAndroidStatic

    export let ProgressViewIOS: ProgressViewIOSStatic;
    export type ProgressViewIOS = ProgressViewIOSStatic

    export let RefreshControl: RefreshControlStatic;
    export type RefreshControl = RefreshControlStatic

    export let RecyclerViewBackedScrollView: RecyclerViewBackedScrollViewStatic;
    export type RecyclerViewBackedScrollView = RecyclerViewBackedScrollViewStatic

    export let SegmentedControlIOS: SegmentedControlIOSStatic;
    export type SegmentedControlIOS = SegmentedControlIOSStatic

    export let Slider: SliderStatic;
    export type Slider = SliderStatic

    export let SliderIOS: SliderStatic;
    export type SliderIOS = SliderStatic

    export let StatusBar: StatusBarStatic;
    export type StatusBar = StatusBarStatic

    export let ScrollView: ScrollViewStatic;
    export type ScrollView = ScrollViewStatic

    export let SnapshotViewIOS: SnapshotViewIOSStatic;
    export type SnapshotViewIOS = SnapshotViewIOSStatic

    export let Systrace: SystraceStatic;
    export type Systrace = SystraceStatic

    export let SwipeableListView: SwipeableListViewStatic;
    export type SwipeableListView = SwipeableListViewStatic

    export let Switch: SwitchStatic;
    export type Switch = SwitchStatic

    export let SwitchIOS: SwitchIOSStatic;
    export type SwitchIOS = SwitchIOSStatic

    export let TabBarIOS: TabBarIOSStatic;
    export type TabBarIOS = TabBarIOSStatic

    export let Text: TextStatic;
    export type Text = TextStatic

    export let TextInput: TextInputStatic;
    export type TextInput = TextInputStatic

    export let ToolbarAndroid: ToolbarAndroidStatic;
    export type ToolbarAndroid = ToolbarAndroidStatic

    export let TouchableHighlight: TouchableHighlightStatic;
    export type TouchableHighlight = TouchableHighlightStatic

    export let TouchableNativeFeedback: TouchableNativeFeedbackStatic;
    export type TouchableNativeFeedback = TouchableNativeFeedbackStatic

    export let TouchableOpacity: TouchableOpacityStatic;
    export type TouchableOpacity = TouchableOpacityStatic

    export let TouchableWithoutFeedback: TouchableWithoutFeedbackStatic;
    export type TouchableWithoutFeedback = TouchableWithoutFeedbackStatic

    export let View: ViewStatic;
    export type View = ViewStatic

    export let ViewPagerAndroid: ViewPagerAndroidStatic;
    export type ViewPagerAndroid = ViewPagerAndroidStatic

    export let WebView: WebViewStatic;
    export type WebView = WebViewStatic


    //////////// APIS //////////////
    export let ActionSheetIOS: ActionSheetIOSStatic;
    export type ActionSheetIOS = ActionSheetIOSStatic

    export let Share: ShareStatic;
    export type Share = ShareStatic

    export let AdSupportIOS: AdSupportIOSStatic;
    export type AdSupportIOS = AdSupportIOSStatic

    export let Alert: AlertStatic;
    export type Alert = AlertStatic

    export let AlertAndroid: AlertAndroidStatic;
    export type AlertAndroid = AlertAndroidStatic

    export let AlertIOS: AlertIOSStatic;
    export type AlertIOS = AlertIOSStatic

    export let AppState: AppStateStatic;
    export type AppState = AppStateStatic;

    export let AppStateIOS: AppStateStatic;
    export type AppStateIOS = AppStateStatic

    export let AsyncStorage: AsyncStorageStatic;
    export type AsyncStorage = AsyncStorageStatic

    export let BackAndroid: BackAndroidStatic;
    export type BackAndroid = BackAndroidStatic

    export let Button: ButtonStatic;
    export type Button = ButtonStatic

    export let CameraRoll: CameraRollStatic;
    export type CameraRoll = CameraRollStatic

    export let Clipboard: ClipboardStatic;
    export type Clipboard = ClipboardStatic

    export let DatePickerAndroid: DatePickerAndroidStatic;
    export type DatePickerAndroid = DatePickerAndroidStatic

    export let Geolocation: GeolocationStatic;
    ...
    export let I18nManager: I18nManagerStatic;
    export type I18nManager = I18nManagerStatic

    export let ImageEditor: ImageEditorStatic;
    export type ImageEditor = ImageEditorStatic

    export let ImageStore: ImageStoreStatic;
    export type ImageStore = ImageStoreStatic

    export let InteractionManager: InteractionManagerStatic;

    export let IntentAndroid: IntentAndroidStatic;
    export type IntentAndroid = IntentAndroidStatic

    export let Keyboard: NativeEventEmitter;

    export let KeyboardAvoidingView: KeyboardAvoidingViewStatic;
    export type KeyboardAvoidingView = KeyboardAvoidingViewStatic

    export let Linking: LinkingStatic;
    export type Linking = LinkingStatic

    export let LinkingIOS: LinkingIOSStatic;
    export type LinkingIOS = LinkingIOSStatic

    export let NativeMethodsMixin: NativeMethodsMixinStatic;
    export type NativeMethodsMixin = NativeMethodsMixinStatic

    export let NativeComponent: NativeMethodsMixinStatic;
    export type NativeComponent = NativeMethodsMixinStatic

    export let NetInfo: NetInfoStatic;
    export type NetInfo = NetInfoStatic

    export let PanResponder: PanResponderStatic;
    export type PanResponder = PanResponderStatic

    export let PermissionsAndroid: PermissionsAndroidStatic;
    ...
    export let Settings: SettingsStatic;
    export type Settings = SettingsStatic

    export let StatusBarIOS: StatusBarIOSStatic;
    export type StatusBarIOS = StatusBarIOSStatic

    export let TimePickerAndroid: TimePickerAndroidStatic;
    export type TimePickerAndroid = TimePickerAndroidStatic

    export let ToastAndroid: ToastAndroidStatic;
    export type ToastAndroid = ToastAndroidStatic

    export let UIManager: UIManagerStatic;
    export type UIManager = UIManagerStatic

    export let VibrationIOS: VibrationIOSStatic;
    export type VibrationIOS = VibrationIOSStatic

    export let Vibration: VibrationStatic;
    export type Vibration = VibrationStatic

    export let Dimensions: Dimensions;
    export let ShadowPropTypesIOS: ShadowPropTypesIOSStatic;

    export type NavigationExperimental = NavigationExperimentalStatic;
    export let NavigationExperimental: NavigationExperimentalStatic;

    export type Easing = EasingStatic;
    export let Easing: EasingStatic;

    //////////// Plugins //////////////

    export let DeviceEventEmitter: DeviceEventEmitterStatic;
    /**
    ...
    export let NativeEventEmitter: NativeEventEmitter;
    /**
     * Deprecated - subclass NativeEventEmitter to create granular event modules instead of
     * adding all event listeners directly to RCTNativeAppEventEmitter.
     */
    export let NativeAppEventEmitter: RCTNativeAppEventEmitter;
    /**
     ...
     */
    export let NativeModules: any;
    export let Platform: PlatformStatic;
    export let PixelRatio: PixelRatioStatic;
     ...
     */
    export function requireNativeComponent<P>(viewName: string,
                                              componentInterface?: ComponentInterface<P>,
                                              extraConfig?: {nativeOnly?: any}): React.ComponentClass<P>;
    ...
    namespace addons {
        ...
        export let TestModule: TestModuleStatic;
    ...
    // Prop Types
    //
    export let ColorPropType: Requireable<any>;
    export let EdgeInsetsPropType: Requireable<any>;
    export let PointPropType: Requireable<any>;
...
global {
    ...
    function fetch(url: string, options?: Object): Promise<any>;
